				...
				<tr>
					<td>
						<table>
							...
							<tr>
								<td align="center">
									<textarea name="contents" cols="60" rows="6"><%=bean.getContents() %></textarea>
								</td>
							</tr>
							<tr>
								...
								<input type="checkbox" name="secret" value="1" 	<%if(bean.getSecret().equals("1")) 
									out.print("checked");%>>비밀글
								</td>
							</tr>
						</table>
					</td>
